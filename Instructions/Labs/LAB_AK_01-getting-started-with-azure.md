...
1. Use the same process to add the following services to your favorites: **Azure IoT Hub Device Provisioning Services**, **Logic Apps**, and **Stream Analytics jobs**.
